...
ppd_generated <- m$generate_quantities(fitted_params = fit_volume, 
                                       data = 'R:/Prosjekter_VVHF/MRS_1000368/mrs_data/volume.json')
ppd <- 
...
contrast_estimates <- fit_volume$draws(format = "draws_df") %>%
...
write_csv(contrast_estimates, file = 'C:/Users/erlrog/OneDrive - Helse Sør-Øst/VVHF-FP-MRS-1000368 - Dokumenter/General/parameter_estimates/volume_contrast_estimates.csv')
